        ...
        <section className="w-full max-w-6xl mx-auto text-left py-32">
            <div className="px-4">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 mt-8">
                    <div>
                        <p className="text-3xl font-medium text-gray-900 dark:text-white">50,000+</p>
                    ...
                    <div>
                        <p className="text-3xl font-medium text-gray-900 dark:text-white">1,200+</p>
                        <p className="text-gray-500 text-md">Enterprise Clients</p>
                    </div>
                    <div>
                        <p className="text-3xl font-medium text-gray-900 dark:text-white">1.2s</p>
