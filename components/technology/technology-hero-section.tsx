    ...
    return (
        <section className="relative w-full min-h-[100vh] flex flex-col items-center justify-center px-6 py-24 overflow-hidden bg-gradient-to-br from-background to-muted/30">
            ...
            bg-background"
                    style={
                        {
                            "--color-1": "hsl(210, 100%, 60%)", // Blue
                            "--color-2": "hsl(280, 80%, 65%)", // Purple
                            "--color-3": "hsl(330, 100%, 65%)", // Pink
                            "--color-4": "hsl(20, 100%, 60%)", // Orange
                            "--color-5": "hsl(140, 70%, 50%)", // Green
                ...
                >
                    Use our component library powered by Shadcn UI & Tailwind CSS to
                    craft beautiful, fast, and accessible UIs.
                </motion.p>
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
