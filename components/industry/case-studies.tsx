    ...
    const caseStudies = [
        {
            id: 1,
            quote:
                "With our platform, design teams finally work in sync. Components are reusable, consistent, and teams ship new features 40% faster.",
            name: "Aarav Mehta",
        ...
        },
        {
            id: 2,
            quote:
                "Our unified dashboard experience helped ops teams reduce time spent on context switching and improved clarity across all projects.",
            name: "Sophia Patel",
        ...
        >
            <div className="container mx-auto px-6">
                ...
                <div className="flex flex-col gap-4 text-center max-w-2xl mx-auto">
                    ...
                    >
                        Real results with our platform
                    </h2>
                    <p className="text-muted-foreground">
                        From design systems to operations—our platform powers teams with speed,
